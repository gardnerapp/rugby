  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          OffenseView(),DefenseView(),PenaltyView()
        ],
      ),
    );
  }
                ...
                decoration: BoxDecoration(
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        ...
                        blurRadius: 10.0)],
                  gradient: LinearGradient(colors: <Color>[Colors.red[500], Colors.red[400], Colors.red[300],Colors.red[200],
                    Colors.white,Colors.blue[200], Colors.blue[300], Colors.blue[400], Colors.blue[500]],
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 4, bottom:3),
                            child: Text("Stops", style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 12,
                              letterSpacing: 0.2,
                              color: Colors.black,
